...
private static final String connectionString = "jdbc:sqlite:C:/logica/db/logica.db";
	...
	public static void buildReportPDF(Report report, String exportPath, HashMap<String, Object> parameters, Collection<?> data) throws Exception {
	...
	public static void buildReportXLSX(Report report, String exportPath, HashMap<String, Object> parameters, Collection<?> data) throws Exception {
		JasperDesign jasperDesign = report.getReport();
		JasperReport jasperReport = JasperCompileManager.compileReport(jasperDesign);
		JRBeanCollectionDataSource beanColDataSource = new JRBeanCollectionDataSource(data);
		JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, parameters, beanColDataSource);
